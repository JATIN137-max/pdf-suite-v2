...
const CompressPdf = () => {
  ...
  return (
    <div className="animate-slide-up" style={{ maxWidth: '800px', margin: '0 auto', paddingTop: '2rem' }}>
      <SEO
        title="Compress PDF Online Free - Reduce File Size | EWN"
        description="Shrink your PDF file size for free. Choose your compression level and see the estimated output size before you download."
        path="/compress-pdf"
      />
